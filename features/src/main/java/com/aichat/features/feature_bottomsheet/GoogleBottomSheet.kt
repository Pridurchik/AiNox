...
import com.aichat.features.databinding.FragmentGoogleBinding
...
) : BaseBottomSheetDialog<FragmentGoogleBinding>(
    context,
    R.layout.fragment_google,
    FragmentGoogleBinding::inflate
) {
